...
def test_methods_file():
    ...
    if fileAR.endswith('AR.linkstream'):
        # algo BBR19
        print(" *************** ", fileAR, "***************")
        g_mV2 = MatchingV2(gamma, path + fileAR)
...
def tocsvForeachDir():
    ...
    fileOutPutTimes = '../outPutFile/gen_test/executionTimes.csv'
    fileOutPutNbGM = '../outPutFile/gen_test/NBGammaMatching.csv'
